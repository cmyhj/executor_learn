...
//    auto node1 = std::make_shared<my_namespace::Node1>("node1");
//    rclcpp::spin(node1);
//    rclcpp::shutdown();
//    return 0;
// }
...
// {
//     rclcpp::init(argc, argv);
//     auto node11 = std::make_shared<my_namespace::Node1>("node11");
//     auto node12 = std::make_shared<my_namespace::Node1>("node12");
